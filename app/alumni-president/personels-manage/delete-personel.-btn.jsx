...
const DeletePersonelBtn = ({ professor_id, fetch }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await axios.delete(
        apiConfig.rmuAPI + `/president/delete-personel-data/${professor_id}`,
        {
          ...
          <div className="w-full flex items-start justify-between pb-3.5 border-b border-gray-300">
            <div className="flex flex-col">
              <span className="flex items-center gap-2">
                ...
                <p className="font-semibold text-lg">ลบข้อมูลบัญชีบุคลากร</p>
              </span>
              <p className="text-sm text-gray-700">
                ยืนยันตัวตนผู้ดำเนินการลบข้อมูลบุคลากร
              </p>
            </div>
            <button
            ...
            <p className="text-sm text-gray-700 mt-3 w-full text-center">
              *!
              {toggleDeleteType == 1
                ...
                : "ข้อมูลบัญนี้จะถูกลบรวมไปถึงข้อมูลที่เกี่ยวข้องกับบัญชีนี้ ได้แก่ ช่องทางการติดต่อ ที่อยู่ และการตั้งค่าความเป็นส่วนตัวจะถูกลบ"}
            </p>
          )} */}
...
export default DeletePersonelBtn;
